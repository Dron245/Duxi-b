(() => {
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth < 1001.98 && targetElement.closest(".header-center__input")) document.querySelector(".header").classList.add("_mobile-searh-top-open");
            ...
            if (document.querySelector(".where") && targetElement.closest(".search-order")) if (targetElement.closest(".calculation__form").querySelector("input").value.length != 0) {
    ...
    if (popupFiltmodal && popupFiltmodal.clientHeight > window.innerHeight - 60) popupContent.classList.add("_overflow-y");
